...
(function() {
  ...
  this.load = function() {
    var actual_row, block_count, center, cid, cid0, col, d, doc, dx, dy, entry, fallback, filename, glyphs, input_routes, max_cid, parser, path, path_count, paths, prefix, route, row, select, selector, source, x, y, _, _i, _j, _k, _len, _len1, _ref;
    ...
    for (cid = _k = _ref = options['cid0']; _ref <= max_cid ? _k <= max_cid : _k >= max_cid; cid = _ref <= max_cid ? ++_k : --_k) {
      if (glyphs[cid] == null) {
